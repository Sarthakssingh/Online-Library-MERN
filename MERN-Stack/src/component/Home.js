...
function Home() {
    ...
    useEffect(async () => {
        ...
        let res = await axios.get("https://jsonblob.com/api/jsonBlob/1051575607531683840")
    ...
    const filterCrimenovel = () => {
        ...
        let filtered = books.filter(v => v.genre == 'Crime')
                        ...
                        filterdata.map((obj, index) => <Col sm={12} md={6} lg={4} >
                            <Card style={{ width: '18rem' }} className="mt-3 card">
                                ...
                                <Card.Body>
                                    ...
                                    <Button variant="success" className="float-end ms-auto" onClick={() => favouritebook(obj)}>Add to Favourites</Button>
